...
export function StorageGrowthEstimator() {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Storage Growth Estimator</CardTitle>
                <CardDescription>
                    Forecast future storage needs based on current size and expected growth rate.
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        <Label htmlFor="initial-size">Initial Size</Label>
