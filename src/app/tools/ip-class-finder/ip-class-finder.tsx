...
const faqData = [
    ...
    { question: "What is CIDR and why did it replace classful addressing?", answer: "CIDR (Classless Inter-Domain Routing) eliminated the rigid boundaries of Class A, B, and C. With CIDR, a network is defined by an IP address and a prefix length (e.g., 192.168.1.0/24). This allows network administrators to create subnets of any size, a process called <a href='/tools/vlsm-calculator' class='text-primary hover:underline'>Variable Length Subnet Masking (VLSM)</a>, which dramatically improves IP address allocation efficiency." },
    { question: "What is the 'default subnet mask' for each class?", answer: "The default mask is the subnet mask that was automatically assumed for a classful address. Class A used 255.0.0.0 (/8), Class B used 255.255.0.0 (/16), and Class C used 255.255.255.0 (/24). You can explore these masks further with our <a href='/tools/subnet-mask-converter' class='text-primary hover:underline'>Subnet Mask Converter</a>." },
    { question: "Are private IP addresses (like 192.168.1.1) still considered Class C?", answer: "Yes and no. The address 192.168.1.1 falls within the numerical range of Class C. However, in modern networking, its behavior is defined by its subnet mask (usually /24), not its class. The term 'Class C' is often used informally to refer to any /24 network, but technically all modern routing is 'classless'. Our <a href='/tools/ip-privacy-checker' class='text-primary hover:underline'>Public vs. Private IP Checker</a> can tell you if an address falls within a private range." },
