...
const faqData = [
    ...
    { question: "How do I choose the right CIDR prefix for my network?", answer: "You should choose the smallest possible subnet (largest CIDR number) that can accommodate your required number of hosts, plus a reasonable buffer for future growth. For example, if you need 50 hosts, you should choose a /26 (62 usable hosts), not a /27 (30 usable hosts). Our <a href='/tools/vlsm-calculator' className='text-primary hover:underline'>VLSM Calculator</a> is designed for this kind of planning." },
    ...
    { question: "Can I determine the number of hosts from a subnet mask?", answer: "Yes. The number of hosts is determined by the number of '0' bits in the binary representation of the subnet mask. This tool simplifies the process by starting with the CIDR prefix. You can use our <a href='/tools/subnet-mask-converter' className='text-primary hover:underline'>Subnet Mask Converter</a> to find the CIDR for any valid mask." },
    { question: "What's the relationship between this and subnetting?", answer: "This calculator is a core part of subnetting. When you perform subnetting, you are deciding how to divide a large network into smaller ones. The primary consideration is how many hosts each smaller subnet needs to support, which in turn determines the CIDR prefix you will assign to it. Our <a href='/tools/subnet-calculator' className='text-primary hover:underline'>Subnet Calculator</a> provides a more complete view of a single subnet." },
];
