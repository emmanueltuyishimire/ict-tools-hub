...
export const faqData = [
    ...
    { question: "What is 'rightsizing'?", answer: "'Rightsizing' is the process of continuously monitoring a VM's actual resource usage and adjusting its size to match its needs. This prevents overprovisioning (wasting money on unused resources) and underprovisioning (causing poor performance)." },
