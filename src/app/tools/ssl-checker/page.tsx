...
export const metadata = {
    ...
    openGraph: {
        title: 'SSL Certificate Checker | ICT Toolbench',
        description: 'Instantly check the validity and details of any SSL/TLS certificate to ensure your connection is secure.',
...
export default function SslCheckerPage() {
    const softwareAppSchema = {
      ...
      "description": "A free online tool to check the validity, issuer, and expiration date of any website's SSL/TLS certificate.",
      "url": "https://www.icttoolbench.com/tools/ssl-checker"
    };
