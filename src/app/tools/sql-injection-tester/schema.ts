...
export const faqData = [
    ...
    { question: "Is sanitizing user input enough to prevent SQLi?", answer: "No. While input sanitization (like stripping out single quotes) can help, it's a fragile, blacklist-based approach. Attackers are constantly finding new ways to bypass sanitization filters using encoding or other tricks. You can learn about encoding with our <a href='/tools/url-encoder-decoder' class='text-primary hover:underline'>URL Encoder / Decoder</a>. Parameterized queries are the only truly reliable defense." },
