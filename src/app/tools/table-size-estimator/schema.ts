...
export const faqData = [
    { question: "Why is estimating table size important?", answer: "Estimating table size is a critical part of capacity planning. It helps you provision the right amount of disk space, preventing service outages caused by full disks. It also allows you to forecast future costs for hardware or cloud services, which is essential for budgeting." },
