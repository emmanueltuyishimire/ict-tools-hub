...
const faqData = [
    ...
    { question: "How can I use this tool to build a regex?", answer: "Start with a simple pattern and a sample test string. Gradually add more complexity to your regex, observing how the matches change in real-time. Use the cheat sheet for reference on different tokens and syntax. The instant feedback loop is the best way to learn and build complex patterns." },
