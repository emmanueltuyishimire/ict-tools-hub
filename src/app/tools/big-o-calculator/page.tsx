                    ...
                    <CardContent className="space-y-6 prose prose-lg max-w-none text-foreground">
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-5">
                                <li><strong>O(1) - Constant Time:</strong> The holy grail of efficiency. The algorithm takes the same amount of time regardless of the input size. Examples include accessing an array element by its index or getting a value from a hash map by its key.</li>
                                <li><strong>O(log n) - Logarithmic Time:</strong> Incredibly efficient. The algorithm's time complexity grows very slowly. If you double the input size, the time it takes only increases by a single step. Binary search on a sorted array is the classic example.</li>
                                <li><strong>O(n) - Linear Time:</strong> A common and generally acceptable complexity. The algorithm's time grows in direct proportion to the input size. If you double the input, the time it takes also doubles. A simple `for` loop that iterates through every element of an array is O(n).</li>
                                <li><strong>O(n log n) - Log-Linear Time:</strong> This complexity is slightly worse than linear but still very efficient for most problems. The most efficient general-purpose sorting algorithms, like Merge Sort and Heap Sort, have O(n log n) time complexity.</li>
                                <li><strong>O(n²) - Quadratic Time:</strong> Performance starts to degrade quickly. The time grows with the square of the input size. A common example is a nested loop where you compare every element of a collection to every other element. This is acceptable for small `n`, but becomes very slow for large `n`.</li>
                                <li><strong>O(2ⁿ) - Exponential Time:</strong> Danger zone. The algorithm's runtime doubles with every single new element added to the input. This is often seen in recursive solutions to problems like finding the Fibonacci sequence. These algorithms are only practical for trivial input sizes.</li>
                            </ul>
                        </section>
                    </CardContent>
                </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <ul className="list-disc pl-5 space-y-3 text-sm text-muted-foreground">
                                <li><strong>Know Your Data Structures:</strong> The time complexity of an operation depends heavily on the data structure. Accessing an element in a hash map is O(1), but in a linked list, it's O(n).</li>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <ul className="list-disc pl-5 space-y-3 text-sm text-muted-foreground">
                                ...
                                <li><strong>Misinterpreting Nested Loops:</strong> A nested loop does not always mean O(n²). If the inner loop's iterations depend on the outer loop in a non-linear way, or if the loops iterate over different collections, the complexity could be different.</li>
