...
export const faqData = [
    { question: "Why is estimating database storage important?", answer: "Estimating storage is a critical part of capacity planning. It helps you provision the right amount of disk space, preventing service outages caused by full disks. It also allows you to forecast future costs for hardware or cloud services, which is essential for budgeting." },
    { question: "What is 'index and overhead'?", answer: "Indexes are special data structures that speed up data retrieval but consume additional storage space. Overhead includes space used by the database for metadata, transaction logs, and internal structures. A typical overhead estimate is 25-50% of the raw data size, but can be much higher for tables with many indexes." },
    ...
    { question: "How can I find my database's current size and growth rate?", answer: "Most database systems provide built-in commands or views to check the size of tables and the entire database (e.g., `pg_size_pretty()` in PostgreSQL). To find the growth rate, you need to record these sizes over time (e.g., weekly or monthly) and calculate the percentage increase." },
...
export const howToSchema = {
    ...
    '@type': 'HowTo',
    name: 'How to Estimate Database Storage Size',
