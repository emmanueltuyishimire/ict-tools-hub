...
const VmScalingGuidePage = () => {
    ...
    const softwareAppSchema = {
      ...
      "name": "VM Scaling Planning Guide",
      "operatingSystem": "All",
      ...
      "description": "An educational guide for planning and understanding virtual machine scaling strategies, including vertical and horizontal scaling.",
      "url": "https://www.icttoolbench.com/tools/vm-scaling-calculator"
    };
...
export default VmScalingGuidePage;
