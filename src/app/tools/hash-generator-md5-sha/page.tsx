        ...
        <section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-card p-6 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">When you sign up for a website, the service should never store your password in plain text. Instead, they hash it (with a salt). When you log in, they hash the password you just entered and compare it to the stored hash. If they match, you're authenticated. This way, even if their database is breached, the attackers only get a list of hashes, not the actual passwords. Our <a href='/tools/password-strength-checker' class='text-primary hover:underline'>Password Strength Checker</a> can help you create strong passwords to begin with.</p>
                </div>
                 <div className="bg-card p-6 rounded-lg">
                    <h3 className="font-semibold text-lg mb-2">File Integrity Verification</h3>
                    <p className="text-sm text-muted-foreground">A software developer releases a new program. Alongside the download link, they publish the SHA-256 hash of the installation file. Users can download the file, calculate its hash on their own computer, and compare it to the one on the website. If the hashes match, the user can be confident that the file was not corrupted during download or tampered with by a third party. This can be verified with our <a href='/tools/file-integrity-checker' class='text-primary hover:underline'>File Integrity Checker</a> tool.</p>
                </div>
                 <div className="bg-card p-6 rounded-lg">
