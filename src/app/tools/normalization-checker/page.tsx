                            ...
                            <ul className="space-y-4">
                                ...
                                <li className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                           Use auto-incrementing integers or UUIDs as your primary keys. They are stable and have no business meaning, which prevents issues when natural data (like an email address) changes. You can use our <Link href="/tools/random-string-generator" className="text-primary hover:underline">Random String Generator</Link> to create UUIDs.
                                        </p>
                                    </div>
                                </li>
                                 <li className="flex items-start gap-4">
