...
export const faqData = [
    ...
    { question: "Should I add an index to my foreign key columns?", answer: "Yes, almost always. Creating a database index on your foreign key columns is one of the most important performance optimizations you can make. It dramatically speeds up `JOIN` operations. You can use our <a href='/tools/index-size-calculator' class='text-primary hover:underline'>Index Size Calculator</a> to estimate the storage cost of doing so." },
