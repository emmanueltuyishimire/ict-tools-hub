...
const faqData = [
    ...
    { question: "What is a subnet mask?", answer: "A subnet mask is a 32-bit number that separates the network portion of an IP address from the host portion. The '1's in the mask represent the network bits, and the '0's represent the host bits. For example, `255.255.255.0` is `11111111.11111111.11111111.00000000` in binary." },
            ...
            <Card className='bg-secondary/30 border-primary/20'>
                ...
                <CardContent className="space-y-6 prose prose-lg max-w-none text-foreground">
                    ...
                    <section>
                        ...
                        <p>An IP address is always analyzed in binary. A subnet mask consists of a series of consecutive '1's followed by a series of consecutive '0's. The '1's in the mask correspond to the network portion of the IP, and the '0's correspond to the host portion.</p>
