...
export const faqData = [
    ...
    { question: "What happens to numbers and symbols?", answer: "The standard Caesar cipher only applies to alphabetic characters. Numbers, symbols, and whitespace are typically left unchanged. This is a weakness, as they can provide clues to a cryptanalyst." },
    ...
    { question: "What is frequency analysis?", answer: "Frequency analysis is a technique for breaking ciphers by observing how often different letters appear in the ciphertext. In English, 'E' is the most common letter. If 'H' is the most common letter in your ciphertext, it's very likely that 'E' was shifted to become 'H', which would reveal a shift of 3." },
];
