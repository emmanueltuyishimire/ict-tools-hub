export const faqData = [
    ...
    { question: "Where is Base32 primarily used?", answer: "Base32 is often used in applications where case-insensitivity is important or where the output might be used in filesystems or DNS records. It's also commonly used for the manual-entry 'secret keys' in two-factor authentication systems." },
...
export const keyTerminologies = [
    { term: 'Base32', definition: 'An encoding scheme using a 32-character set (A-Z, 2-7). It is case-insensitive.' },
    { term: 'Base58', definition: 'An encoding scheme designed for human-readability, omitting visually ambiguous characters like 0, O, I, and l. Famously used for Bitcoin addresses.' },
    ...
    { term: 'Checksum', definition: 'A small piece of data derived from a block of digital data for the purpose of detecting errors that may have been introduced during its transmission or storage.' },
