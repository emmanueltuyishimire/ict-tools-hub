...
const faqData = [
    ...
    { question: "Why do I see strange characters like `%C3%A9` in URLs?", answer: "This is how non-ASCII characters (like `é`, `ü`, or `ñ`) are represented. The character is first encoded into its UTF-8 byte sequence, and then each byte in that sequence is percent-encoded. For example, the character `é` is represented by two bytes in UTF-8 (`C3` and `A9`), resulting in the encoded string `%C3%A9`." }
];
